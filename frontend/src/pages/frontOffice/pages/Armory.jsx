...
export default function Armory() {
  const badges = [
    { id: 1, name: 'First Blood', description: 'Win your first battle', icon: <Swords className="text-red-500" /> },
    { id: 2, name: 'Clean Coder', description: 'Pass 10 battles with perfect syntax', icon: <Shield className="text-blue-500" /> },
    { id: 3, name: 'Recursion Master', description: 'Defeat the Golem', icon: <Award className="text-purple-500" /> },
  ];
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <section className="flex items-center gap-8 mb-12">
          <div className="relative group">
            <div className="w-32 h-32 rounded-full border-4 border-amber-500 shadow-[0_0_30px_rgba(251,191,36,0.3)] overflow-hidden">
              <img src="https://ui-avatars.com/api/?name=Champion&background=0f172a&color=3b82f6&size=128" alt="Champion Avatar" />
            </div>
            <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-amber-500 rounded-full border-4 border-slate-900 flex items-center justify-center text-slate-900 font-bold">
              12
            </div>
          </div>
          <div>
            <h1 className="text-4xl font-serif font-bold text-amber-100 mb-2">Champion "The Coder"</h1>
            ...
            <div className="flex gap-4 mt-4">
              <div className="px-4 py-2 bg-slate-900 rounded border border-slate-700">
                ...
                <div className="text-xl font-bold text-amber-400">1,250</div>
              </div>
              <div className="px-4 py-2 bg-slate-900 rounded border border-slate-700">
          ...
          <Card variant="parchment" className="overflow-hidden">
             <div className="overflow-x-auto">
                <table className="w-full text-left text-sm">
                  <thead className="bg-amber-900/10 border-b border-amber-900/20 text-amber-900 uppercase font-serif tracking-wider">
                    <tr>
                  ...
                  <tbody className="divide-y divide-amber-900/10 text-slate-800">
                    {leaders.map((leader) => (
                      <tr key={leader.rank} className="hover:bg-amber-900/5 transition-colors">
                        ...
                        <td className="px-6 py-4 text-right font-mono font-bold text-amber-700">{leader.score.toLocaleString()}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
